...
public class Village {
	...
	/**
	 * Permets de féter le solstice d'été
	 */
	public void solstice_d_ete() {
		...
		System.out.println("Nombre de Schtroumpfs présents : " + this.getNbSchtroumpf());
		System.out.println("Nombre de Schtroumpfs contents : " + nbSchtroumpfsContent);
	}
	
	/** Permets d'obtenir le chef du village ( Schtroumpf le plus agé )
	 * @return Schtroumpf Schtroumpf le plus agé
	 */
